...
*/
     ...
     private static void testSonucu(char[][] answers, char[] keys) {
          ...
          for (int i = 0; i < answers.length; i++) { // her bir ogrenciye bakar, i -> ogrenciyi temsil ediyor
               int sayac =0;// her bir ogrencinin dogru cevabini sayacagi icin sayac buraya konulur
